...
- (id)initWithFrame:(CGRect)frame pages:(NSArray*)pagesArray
{
    ...
    if(self != nil) {
        ...
        for(int i = 0; i <  pages.count; i++) {
            ...
            if (i == pages.count - 1) {
                UIImage *faceImage = [UIImage imageNamed:@"start_button.png"];
                startButton = [UIButton buttonWithType:UIButtonTypeCustom];
                startButton.frame = CGRectMake( (pages.count - 1) * 320 + 80, 377, 160, 37 );
                [startButton setImage:faceImage forState:UIControlStateNormal];
