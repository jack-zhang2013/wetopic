...
- (id)initWithFrame:(CGRect)frame model:(IntroModel*)model
{
    ...
    if (self) {
        ...
        CGSize s = [descriptionLabel.text sizeWithFont:descriptionLabel.font constrainedToSize:CGSizeMake(frame.size.width-10, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
        
        //three lines height
        CGSize three = [@"1 \n 2 \n 3" sizeWithFont:descriptionLabel.font constrainedToSize:CGSizeMake(frame.size.width-10, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
