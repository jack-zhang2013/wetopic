...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = NSLocalizedString(@"more_feedback", nil);
...
- (void)postFinishedWithError:(NSError *)error
{
    ...
    if (!error) {
        alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"feedbackok", nil) message:nil delegate:nil cancelButtonTitle:NSLocalizedString(@"more_logout_yes", nil) otherButtonTitles:nil];
    } else{
        alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"feedbackfail", nil) message:nil delegate:nil cancelButtonTitle:NSLocalizedString(@"more_logout_yes", nil) otherButtonTitles:nil];
    }
    [alertView show];
