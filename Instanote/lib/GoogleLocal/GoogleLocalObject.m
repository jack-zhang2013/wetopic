...
@synthesize title, subtitle,titles, subtitles;
@synthesize coordinate, streetAddress, phoneNumber, city, region, country, searchTerms, fullAddressArray, fullAddressString;
